     ...
     <div  className=" basis-full bg-white rounded-md group sm:basis-56 lg:basis-60 2xl:basis-80">
        ...
        <div className="px-2 pt-4 pb-2">
          ...
          <div className='flex flex-col gap-2 mt-4'>
            <Link className='bg-stone-700 text-center text-white text-xl px-4 py-2 rounded-md transition-all duration-300 hover:bg-black' to={`/auction/details/${id}`}>View Auction</Link>
            <button className='bg-red-400 text-center text-white text-xl px-4 py-2 rounded-md transition-all duration-300 hover:bg-red-600' onClick={handleDeleteAuction}>Delete Auction</button>
            <button className='bg-green-400 text-center text-white text-xl px-4 py-2 rounded-md transition-all duration-300 hover:bg-green-700' disabled={new Date(endTime) > Date.now()} onClick={()=>setopenDrawer(true)}>Republish Auction</button>
          </div>
        </div>
      </div>
