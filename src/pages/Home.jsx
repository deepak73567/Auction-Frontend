        ...
        <div className="flex gap-4 my-8">
          {!isAuthenticated && (
            <>
              <Link
                to="/sign-up"
                className="bg-[#D8125B] font-semibold hover:bg-[#f72572] rounded-md px-8 flex items-center py-2 text-white transition-all duration-300"
              >
                Sign Up
              </Link>
              <Link
                to="/login"
                className="text-[#D8125B] bg-transparent border-2 border-[#DECCBE] hover:bg-[#fff3fd18] hover:text-[#181717] font-bold text-xl rounded-md px-8 flex items-center py-2 transition-all duration-300"
              >
                Login
              </Link>
            </>
