...
const SubmitCommission = () => {
  ...
  return (
    <>
    <section className="w-full ml-0 m-0 px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen bg-[#f9f7f7] items-start">
    <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-start py-4 justify-start rounded-md sm:w-[600px]">
        <form className="flex flex-col gap-5 w-full" onSubmit={handlePaymentProof}>
            ...
            <div className="flex flex-col gap-2">
                ...
                <textarea value={comment} onChange={(e)=>setComment(e.target.value)} rows={7}  className="text-[16px] py-2 bg-transparent border-[1px] rounded-md px-1 border-stone-500 focus:outline-none" />
            </div>
            <button className='bg-[#D8125B] font-semibold hover:bg-[#fa367e] text-xl transition-all duration-300  py-2 px-4 rounded-md text-white  mx-auto lg:w-[300px] sm:w-[300px] mb-4' type='submit' disabled={loading}>
