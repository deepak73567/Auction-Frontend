    ...
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Founded by <span className="text-[#2bcdd6] underline ">CodeWithDeepak</span>, PrimeBid was born out of a passion for
        ...
        <div>
          <p className="text-[#D8125B] text-xl font-bold mb-3">
